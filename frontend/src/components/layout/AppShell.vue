<template>
  <div class="mx-auto flex min-h-screen flex-col md:flex-row bg-background">
    ...
    <!-- Mobile Bottom Nav -->
    <nav class="fixed bottom-0 left-0 right-0 grid grid-cols-5 border-t border-neutral-100 bg-white/90 backdrop-blur-lg px-2 py-2 md:hidden z-50 safe-bottom shadow-[0_-4px_20px_rgba(0,0,0,0.02)]">
